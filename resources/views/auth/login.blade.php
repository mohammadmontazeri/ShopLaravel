...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="social-auth-links text-center">
            ...
            <a href="{{route('register')}}" class="btn btn-block btn-social btn-google btn-flat" style="display: block;text-align: center;border-radius: 3px;"> تا به حال ثبت نام نکرده اید؟</a>
