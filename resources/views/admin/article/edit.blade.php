            ...
            <form method="POST" action="{{route('article.update',['article'=> $article->id])}}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        foreach ($cats as $cat){
                        ?>
                        <option value="{{$cat->id}}" <?php if ($cat->id == $article->cat_id){echo "selected";} ?>>{{$cat->name}}</option>
                        <?php
                        }
                        echo "</select>";
                        ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="summery" value="{{$article->summery}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">متن محتوا</label>
                        <textarea class="form-control" id="editor1"  name="detail">{{$article->detail}}
                </textarea>
                    </div>
                    <hr>
                    <div class="form-group" style="display: flex">
                        <div style="border-left: solid 1px #ddd;padding-left: 20px">
                            <label for="exampleInputEmail1" style="color: #f0004c"> تگ ها این مقاله</label>
                            <?php
                            $tags_ = explode(',',$article->tag);
                            $num = count($tags_);
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{asset("public/$article->image")}}" alt="" width="75px">
                    </div>
                </div><!-- /.box-body -->
