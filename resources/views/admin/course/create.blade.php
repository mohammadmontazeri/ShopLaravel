            ...
            <form method="POST" action="{{route('course.store')}}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title"   placeholder="عنوان دوره آموزشی خود را وارد کنید">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">هزینه دوره</label>
                        <input type="text" class="form-control" name="price"   placeholder="هزینه دوره آموزشی خود را وارد کنید">
                    </div>
                    <div class="form-group">
