...
@section('content')
    <div class="container">
        <div class="alert alert-info" style="direction: rtl;text-align: center">
            تمام محتوای آموزشی مربوط به <span>دسته</span> <span style="font-weight: bold;border-bottom:solid 1px #31708f"> {{$category->name}} </span>
        </div>
                        ...
                        <div class="new-collections">
                            <div class="container">
                                <div class="new-collections-grids" style="direction: rtl">
                                    <?php
                                    $courses = \App\Course::where('cat_id',"$category->id")->paginate(4);
                                    if (count($courses)==0){
                                        ?>
                    ...
                    <div>
                        <div class="new-collections">
                            <div class="container">
                                <div class="new-collections-grids" style="direction: rtl">
                                    <?php
                                    $articles = \App\Article::where('cat_id',"$category->id")->paginate(4);
                                    if (count($articles)==0){
                                        ?>
                                        <div class="alert alert-danger">
                                        ...
                                        <div class="new-collections-grid1" data-wow-delay=".5s">
                                            ...
                                            <div style="padding: 0.5em;">
                                                ...
                                                <div class="new-collections-grid1-left simpleCart_shelfItem" style="display: flex;justify-content: space-between">
                                                    ...
                                                    <span style="direction:rtl;color: #fff;border-radius:2px;font-weight: bold;background-color: #595959;padding: 5px 8px;box-sizing: border-box;font-size: 0.9em;"><?php
                                                        $category = \App\Category::where('id',$category->id)->get()->first();
                                                        echo $category->name;
                                                        ?></span>
                                                </div>
                                            </div>
